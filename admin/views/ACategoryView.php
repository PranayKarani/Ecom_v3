...
class ACategoryView {
    ...
    public function __construct ($name) {
        $this->name = $name;
        $this->c_details = ACategoryController::getCategoryDetails($name);
    }

    public static function showCategorySelector ($dept, $element_id = null, $element_class = null, $category = null, $disable = null) {

        $category_list = ACategoryController::getCategories($dept);
    ...
    public function show_details () {
        ...
        ADepartmentView::showDepartmentSelector($dept, "department", "input");
